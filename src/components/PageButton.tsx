...
const pageButtonOptions :PageButtonOptions = {
    ...
    false: "bg-gray-900 text-gray-300 hover:bg-gray-300 hover:text-gray-900"
}

  return (
    <div className={`px-4 py-2  rounded-lg transition-all duration-100 ${pageButtonOptions[isActive]}`} onClick={clickHandler}>
      {children}
    </div>
  )
}
