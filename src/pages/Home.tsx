...
//   const addMoviesToFirestore = () => {
//     data.forEach(async (movie) => {
//       try {
//         const docRef = await collection(db,'movies').addDoc(movie);
...
//           />
//         </div>
//         <button className='px-4 py-2 bg-red-500 rounded-full' onClick={() => addMoviesToFirestore()}>Dodaj</button>
