...
export const data: SingleMovieType[] = [
  ...
  },
  {
    ...
    genre: ['Animation', 'Adventure', 'Comedy'],
    director: ['Lee Unkrich', 'Adrian Molina (co-directed by)'],
    writers: [
  ...
  },
  {
    ...
    year: 2022,
    image:
      'https://m.media-amazon.com/images/M/MV5BZWYzOGEwNTgtNWU3NS00ZTQ0LWJkODUtMmVhMjIwMjA1ZmQwXkEyXkFqcGdeQXVyMjkwOTAyMDU@._V1_QL75_UX380_CR0,0,380,562_.jpg',
    description:
  ...
  },
  {
    ...
    director: ['David Lean'],
    writers: ['Robert Bolt (screenplay by)', 'Michael Wilson (screenplay by)'],
    imdbid: 'tt0056172',
  },
  {
    rank: 97,
  ...
  },
  {
    ...
    year: 1958,
    image:
      'https://m.media-amazon.com/images/M/MV5BYTE4ODEwZDUtNDFjOC00NjAxLWEzYTQtYTI1NGVmZmFlNjdiL2ltYWdlL2ltYWdlXkEyXkFqcGdeQXVyNjc1NTYyMjg@._V1_QL75_UX380_CR0,13,380,562_.jpg',
    description:
